...
{
    public partial class RGB_to_HSI : Form
    {
        public RGB_to_HSI()
        {
            InitializeComponent();
            ...
            List<Bitmap> HSI = chuyendoirgbsang_hsi(hinhgoc);
            pic_hue.Image = HSI[0];
            pic_saturation.Image = HSI[1];
            pic_intensity.Image = HSI[2];
            pic_hsi.Image = HSI[3];
        }
        public List<Bitmap> chuyendoirgbsang_hsi(Bitmap hinhgoc)
        {
